                ...
                messages=[
                    {
                        ...
                        \n\
                        2デザイン案(プロンプト)生成・ユーザに確認:\n\
                        \n\
                        ここの2章は一番大切なので必ず行ってください。\n\
                        \n\
                        多くてもユーザと4回対話したら回答の整理行ってください。\n\
                        ...
                        \n\
                        ユーザーに確認を促すメッセージも具体的にして、ユーザーが返信しやすい形に工夫します。\n\
