                ...
                messages=[
                    {
                        ...
                        ３ユーザーの回答の整理:\n\
                        \n\
                        ChatGPTに、ユーザーの回答を整理して特定のデザイン要素やスタイルに関する情報を抽出するように指示します。\n\
                        \n\
                        ...
                        ４プロンプト生成・作成:\n\
                        \n\
                        ChatGPTに、得られた情報をもとに画像生成AIに与えるプロンプトを生成するように指示します。\n\
                        \n\
                        ユーザーが選んだデザイン要素や好みに基づいて、画像生成AIに対するプロンプトを作成してください。\n\
                        必ず最後に画像生成AIに送る用のプロンプトを提出してください。"
                    },
                    {
                        "role": "user",
                        "content": sentence
